...
def plot_training_dynamics(history, output_dir="results/baselines/centralized", tag=""):
...
def plot_ipr(history, output_dir="results/baselines/centralized", tag=""):
...
def plot_compare_histories(history_paths, labels, output_dir="results/baselines/centralized", title=""):

...
def collect_local_epochs():
    ...
    return _collect_runs(
        "results/experiments/exp4_optimization/exp4a/history_fed_*_a0.3_K10_le*_ft1.0_iid_s*.json",
        extract_E,
    )
...
def collect_num_clients():
    ...
    return _collect_runs(
        "results/experiments/exp2_aggregation/fl_iid/history_fed_*_a0.3_K*_le5_ft1.0_iid_s*.json",
        extract_K,
    )
...
def collect_heterogeneity():
    ...
    return _collect_runs(
        "results/experiments/exp3_heterogeneity/exp3a/history_fed_*_a0.3_K10_le5_ft1.0_dirichlet_dir*_s*.json",
        extract_dir,
    )
...
def collect_participation():
    ...
    return _collect_runs(
        "results/experiments/exp4_optimization/exp4b/history_fed_*_a0.3_K10_le5_ft*_iid_s*.json",
        extract_f,
    )

...
RESULTS_DIR = "results/experiments/exp4_optimization"
OUTPUT_DIR = "results/experiments/exp4_optimization/figures"
...
def plot_paper_drift_fingerprint():
    ...
    alpha = 0.3
    raw_dir = "results/experiments/exp4_optimization/exp4a"
    cent_path = "results/experiments/exp1_boundary/history_addition_gd_p97_N256_a0.3_s42.json"
...
def plot_paper_cross_run_scatter():
    ...
    points = []
    dirs = [
        ("exp2", "results/experiments/exp2_aggregation/fl_iid"),
        ("exp3", "results/experiments/exp3_heterogeneity/exp3a"),
        ("exp3", "results/experiments/exp3_heterogeneity/exp3b"),
        ("exp4", "results/experiments/exp4_optimization/exp4a"),
        ("exp4", "results/experiments/exp4_optimization/exp4b"),
        ("exp4", "results/experiments/exp4_optimization/exp4c"),
    ]
